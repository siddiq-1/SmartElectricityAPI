...
{
    /// <inheritdoc />
    public partial class CompanyHourlyFeesTransactionsTableFix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CompanyHourlyFeesTransactions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyHourlyFeesTransactions", x => x.Id);

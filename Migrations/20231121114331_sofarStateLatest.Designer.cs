...
namespace SmartElectricityAPI.Migrations
{
    ...
    [Migration("20231121114331_sofarStateLatest")]
    partial class sofarStateLatest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartElectricityAPI.Dto.SofarState", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("SofarState");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Dto.SofarStateLatest", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SofarStateLatest");
                });

...
namespace SmartElectricityAPI.Migrations
{
    ...
    [Migration("20231023182159_BatteryControlHours2")]
    partial class BatteryControlHours2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartElectricityAPI.Dto.SofarState", b =>
                {
                    ...
                    b.Property<double>("grid_freq")
                        .HasColumnType("double");

                    b.Property<int>("grid_power")
                        .HasColumnType("int");

                    b.Property<double>("grid_voltage")
                        .HasColumnType("double");
                    ...
                    b.Property<double>("solarPV1Volt")
                        .HasColumnType("double");
                    ...
                    b.Property<double>("solarPV2Volt")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.BatteryControlHours", b =>
                {
                    ...
                    b.Property<int>("ActionTypeCommand")
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("HourProfit")
                        .HasColumnType("double");

                    b.Property<int>("InverterBatteryId")
                        .HasColumnType("int");

                    b.Property<double?>("LineProfit")
                        .HasColumnType("double");
                    ...
                    b.Property<double?>("MaxMinPriceDifference")
                        .HasColumnType("double");

                    b.Property<TimeSpan?>("MaxPriceHour")
                        .HasColumnType("time(6)");

                    b.Property<double?>("MaxPriceWithCost")
                        .HasColumnType("double");
                    ...
                    b.Property<double?>("MinPriceWithCost")
                        .HasColumnType("double");
                    ...
                    b.Property<int?>("SpotPriceMinId")
                        .HasColumnType("int");

                    b.Property<int?>("UsableWatts")
                        .HasColumnType("int");

                    b.Property<double?>("UsableWattsProfit")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.BatteryControlHours", b =>
                {
                    ...
                    b.HasOne("SmartElectricityAPI.Models.ThirdParty.SpotHintaFi.SpotPrice", "SpotPriceMin")
                        .WithMany()
                        .HasForeignKey("SpotPriceMinId");

                    b.Navigation("InverterBattery");

                    b.Navigation("SpotPriceMax");

                    b.Navigation("SpotPriceMin");
                });

...
namespace SmartElectricityAPI.Migrations
{
    ...
    [Migration("20250417071538_switchModelSuffix")]
    partial class switchModelSuffix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.Company", b =>
                {
                    ...
                    b.Property<double?>("DeviceMinProfitInCents")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.CountryVatRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.DeviceCompanyHours", b =>
                {
                    ...
                    b.Property<string>("DeviceActionType")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("DeviceId", "SpotPriceId", "CompanyId", "DeviceActionType")
                        .IsUnique();
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.InverterBattery", b =>
                {
                    ...
                    b.Property<bool>("ConsiderRemainingBatteryOnPurchase")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConsiderRemainingBatteryOnPurchase = false,
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.Sensor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DeviceActionType = "Off",
                            DeviceId = 1,
                            Name = "Õhk-Vesi Põrand Off",
                            SwitchModelId = 1,
                            Topic = "shellyplus1-virgo1/rpc"
                        });
                });
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.SofarStateHourly", b =>
                {
                    ...
                    b.Property<double>("CostOfConsumpWithOutMygGid")
                        .HasColumnType("double");

                    b.Property<double>("CostPurchaseMinusSellFromGrid")
                        .HasColumnType("double");
                    ...
                    b.Property<double>("WinOrLoseFromMyGridUsage")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.SwitchModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SwitchModel");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Shelly Plus 1 ver 000"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Shelly Plug S ver 000"
                        });
                });

            modelBuilder.Entity("SmartElectricityAPI.Models.SwitchModelParameters", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SwitchModelParameters");
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.Sensor", b =>
                {
                    ...
                    b.HasOne("SmartElectricityAPI.Models.SwitchModel", "SwitchModel")
                        .WithMany()

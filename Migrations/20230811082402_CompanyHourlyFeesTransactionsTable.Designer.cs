...
namespace SmartElectricityAPI.Migrations
{
    ...
    [Migration("20230811082402_CompanyHourlyFeesTransactionsTable")]
    partial class CompanyHourlyFeesTransactionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.CompanyHourlyFees", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CompanyHourlyFees");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BrokerServiceFree = 0.071999999999999995,
                            CompanyId = 1,
                            NetworkServiceFree = 0.050500000000000003,
                        ...
                        new
                        {
                            ...
                            BrokerServiceFree = 0.071999999999999995,
                            CompanyId = 1,
                            NetworkServiceFree = 0.086800000000000002,
            ...
            modelBuilder.Entity("SmartElectricityAPI.Models.CompanyHourlyFeesTransactions", b =>
                {
                    b.HasBaseType("SmartElectricityAPI.Models.CompanyHourlyFees");

                    b.Property<DateOnly>("Date")
                        .HasColumnType("date");

                    b.HasDiscriminator().HasValue("CompanyHourlyFeesTransactions");
                });

...
public class SofarStateHourly : BaseEntity
{
    [Key]
    ...
    public double CostOfConsumpWithOutMygGid { get; set; }
    [Description("MyGrid Cost Purchades-sell from Grig €")]
    public double CostPurchaseMinusSellFromGrid { get; set; }
    [Description("+ Win/ - lose from MyGrid usage €")]
    public double WinOrLoseFromMyGridUsage { get; set; }
}
